...
public class RetailItem
{
   ...
   public void setWholesale(double w){
       // WC - sets wholesale field from cost object to w
       cost.wholesale = w;
   }
   
   public double getWholesale(){
       // WC - returns wholesale field from cost object
       return cost.wholesale;
   }
   
   public void setRetail(double r){
       // WC - sets retail field from cost object to r
       cost.retail = r;
   }
   
   public double getRetail(){
       // WC - returns retail field from cost object
       return cost.retail;
   }
